...
class TestCase(base.BaseTestCase):
    def setUp(self):
        ...
        self.context = cloudpulse_context.RequestContext(
        ...
        def make_context(*args, **kwargs):
            ...
            context = cloudpulse_context.RequestContext(*args, **kwargs)
            return cloudpulse_context.RequestContext.from_dict(context.to_dict())

        p = mock.patch.object(cloudpulse_context, 'make_context',
